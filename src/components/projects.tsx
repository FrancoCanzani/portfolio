  ...
  return (
    <section className='mb-12' id='projects'>
      ...
      <div className='flex gap-3 flex-wrap'>
        ...
        />
        <ProjectCard
          name={'Furniture API + Showcase'}
          description={t('furnitureAPI.description')}
          href='https://github.com/FrancoCanzani/furniture-api'
          technologies={[
            'Node.js',
            'Express',
            'React',
        ...
        <ProjectCard
          name={'Encrypt & Share'}
          description={t('encryptShare.description')}
          href='https://github.com/FrancoCanzani/encrypt-share'
          technologies={['Golang', 'React', 'TailwindCSS', 'AES-256-GCM']}
        />
        <ProjectCard
          name={'Portfolio'}
