  ...
  return (
    <div className="w-full">
      ...
      <div className="flex items-center justify-center w-full">
        <span className="mr-1 text-sm font-medium">Less</span>
