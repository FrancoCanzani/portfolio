        ...
        <div className='w-full bg-indigo-100'>
          <div className='flex flex-col flex-wrap items-center justify-center p-2 py-10 sm:px-24 md:px-28 lg:px-36'>
            <div className='capitalize'>
              <a
                className='mr-3 bg-black px-4 py-2 font-semibold text-white hover:bg-orange-400 lg:px-8'
              ...
              <a
                className='mr-3 bg-black px-4 py-2 font-semibold text-white hover:bg-green-500 lg:px-8'
                href='wa.link/h37pvs'
                target='blank'
              >
                Chat on WhatsApp
              ...
              <a
                className='mr-3 bg-black px-4 py-2 font-semibold text-white hover:bg-red-500 lg:px-8'
